...
func main() {
	...
	*/
	...
	rootResolver := &RootTargetResolver{root}

	httpResolver := NewHTTPProtocolTargetResolver(dockerResolver, hostResolver, brokerResolver, brokerMonitorResolver, rootResolver)
